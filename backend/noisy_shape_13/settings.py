"""
Django settings for noisy_shape_13 project.
...
ROOT_URLCONF = 'noisy_shape_13.urls'
...
WSGI_APPLICATION = 'noisy_shape_13.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_shape_13 API",
    "DESCRIPTION": "API documentation for noisy_shape_13 App",
    "VERSION": "v1",
}
